            ...
            <div class="col-lg-6 col-lg-offset-3">
                <form action="proses.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="diagnosa" id="diagnosa" class="form-control" rows="4" placeholder="Setelah Menulis Keluhan akan di beri diagnosa oleh Bengkel kurang dari 5 menit setelah sepeda motor berada di bengkel"></textarea>
                    </div>
                    <div class="form-group">
