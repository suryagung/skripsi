    ...
    <div class="box">
        ...
        <h4>
            ...
            <div class="pull-right">
                ...
                <a href="generate.php" class="btn btn-success btn-xs"><i class="glyphicon glyphicon-plus"></i>Tambah Status</a>
            </div>
        </h4>
                   ...
                   if(mysqli_num_rows($sql_status) > 0){
                       while($data= mysqli_fetch_array($sql_status)){?>
                        <tr>
                            ...
                            <td align="center">
                            <input type="checkbox" name="checked[]" class="check" value="<?=$data['id_status']?>">
                            </td>
                        </tr>
                    <?php
                       }
